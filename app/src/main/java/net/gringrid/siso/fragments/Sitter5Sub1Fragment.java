 ...
 */
public class Sitter5Sub1Fragment extends Fragment implements SisoPicker.OnClickPlusMinusListener, View.OnClickListener {
    ...
    private void saveData() {
        ...
        mSitter.mon = result.substring(7*0, 7*0+7);
        mSitter.tue = result.substring(7*1, 7*1+7);
        mSitter.wed = result.substring(7*2, 7*2+7);
        mSitter.thu = result.substring(7*3, 7*3+7);
        mSitter.fri = result.substring(7*4, 7*4+6);
        mSitter.sat = result.substring(7*5, 7*5+7);
        mSitter.sun = result.substring(7*6, 7*6+7);
