 ...
 */
public class Sitter05CommuteFragment extends Fragment implements View.OnClickListener {
    ...
    public Sitter05CommuteFragment() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: SITTER5 : "+mUser.toString());
