...
/**
 * 구인정보 등록 완료 - 좋은 시터를 구하고 싶나요?
 */
public class ParentGuideFragment extends InputBaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_parent_guide, container, false);
    }
