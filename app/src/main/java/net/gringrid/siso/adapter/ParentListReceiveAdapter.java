 ...
 */
public class ParentListReceiveAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ParentListReceiveAdapter(Context mContext, Activity activity, String userEmail, List<SitterListItem> list) {
