 ...
 */
public class ParentListSendAdapter extends BaseAdapter{
    ...
    public ParentListSendAdapter(Context mContext, Activity activity, String userEmail, List<SitterListItem> list) {
