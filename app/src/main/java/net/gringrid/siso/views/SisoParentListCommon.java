 ...
 */
public class SisoParentListCommon extends LinearLayout implements View.OnClickListener {
    ...
    public SisoParentListCommon(Context context){
        super(context);
        initView();
    }

    public SisoParentListCommon(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
        getAttrs(attrs);
    }

    public SisoParentListCommon(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        initView();
