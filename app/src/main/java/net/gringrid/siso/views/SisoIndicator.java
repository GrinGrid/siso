...
public class SisoIndicator extends View {

    private static final String TAG="jiho";

    private static final BallTriangleIndicator DEFAULT_INDICATOR = new BallTriangleIndicator();
    ...
    public SisoIndicator(Context context) {
        super(context);
        init(context, null,0,0);
    }

    public SisoIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0,R.style.AVLoadingIndicatorView);
    }

    public SisoIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr,R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SisoIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
